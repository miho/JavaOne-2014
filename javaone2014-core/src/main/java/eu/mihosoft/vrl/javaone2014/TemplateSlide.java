...
//        setPresentation(presentation);
    ...
    private void initView() {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(
                getClass().getResource("TemplateSlide.fxml"));

        try {
            fxmlLoader.load();
        } catch (IOException ex) {
            Logger.getLogger(TemplateSlide.class.getName()).
        ...
        final ScalableContentPane scalableContentPane =
                new ScalableContentPane();
    ...
    @Override
    public Slide setTitleColor(Color c) {
