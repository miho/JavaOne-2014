...
// */
//public class SimpleMarchingSquares {
//
//    private final Data_float forceField;
//    private final Vector2d[] vertices;
//    boolean[] marked;
//    private final int width;
//    private final int height;
//
//    public SimpleMarchingSquares(Data_float forceField) {
//
...
//    }
//
//    public Path<Float> computePaths(float isoVal) {
//        Path<Float> result = new Path<>(isoVal);
...
//                    forceField.set(0, x, y + 1);
//                }
//
//                if (y < 1) {
//                    forceField.set(0, x, y);
//                    forceField.set(0, x + 1, y);
//                }
//
//                if (x == w - 1) {
//                    forceField.set(0, x + 1, y);
//                    forceField.set(0, x + 1, y + 1);
//                }
//
//                if (y == h - 1) {
//                    forceField.set(0, x, y + 1);
...
//    }
//
//    private void interpolatePoint(float isoVal,
//            int x, int y,
//            Vector2d result,
//            int edgeIndex) {
//
